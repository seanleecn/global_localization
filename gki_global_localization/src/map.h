...
// Description for a change of a single cell.
typedef struct {
    int x;  // map coordinate
    int y;
    int old_occ_state;
    int new_occ_state;
...
// Update the cspace distances
void map_update_cspace_changed(const int x, const int y, const int state,
                               const double max_occ_dist, map_t *map);
void map_update_cspace_changed_cells(const int min_x, const int max_x,
                                     const int min_y, const int max_y,
                                     const double max_occ_dist, map_t *map);
void map_update_cspace_changed_cells1(const int min_x, const int max_x,
                                      const int min_y, const int max_y,
                                      const double max_occ_dist, map_t *map);
